...
export const fetchExerciseGifSync = (name: string): string | null => {
  return EXERCISE_MEDIA_REGISTRY[name] || null;
};
...
const EXERCISE_MEDIA_REGISTRY: Record<string, string> = {
  ...
  "站姿繩索夾胸": "https://fitnessprogramer.com/wp-content/uploads/2021/02/Cable-Crossover.gif",
  ...
  "史密斯上斜臥推": "https://www.docteur-fitness.com/wp-content/uploads/2022/08/developpe-couche-smith-machine.gif",
  ...
  "仰臥器械胸推": "https://www.docteur-fitness.com/wp-content/uploads/2022/11/developpe-machine-assis-pectoraux.gif",
  ...
  "坐姿上斜啞鈴二頭彎舉": "https://www.docteur-fitness.com/wp-content/uploads/2022/08/curl-biceps-avec-halteres-alterne.gif",
  "坐姿啞鈴錘式彎舉": "https://www.docteur-fitness.com/wp-content/uploads/2022/09/curl-haltere-prise-neutre.gif",
  "站姿繩索錘式彎舉": "https://www.docteur-fitness.com/wp-content/uploads/2021/10/curl-biceps-poulie-basse.gif",
  "單臂滑輪三頭下壓": "https://www.aesthetics-blog.com/wp-content/uploads/2023/04/12271301-Cable-Standing-One-Arm-Tricep-Pushdown-Overhand-Grip_Upper-Arms_720.gif",
  "反手直桿下壓": "https://www.docteur-fitness.com/wp-content/uploads/2022/04/curl-inverse-barre.gif",
  ...
  "啞鈴上斜划船": "https://www.docteur-fitness.com/wp-content/uploads/2021/08/rowing-haltere-un-bras.gif",
  ...
  "器械腿內收": "https://www.docteur-fitness.com/wp-content/uploads/2022/02/leg-curl-assis-machine.gif",
...
const EXERCISE_METHODS: Record<string, string> = {
  ...
  "單臂滑輪三頭下壓": "01 面對滑輪機站立，單手握住把手，手肘夾緊肋骨，另一手可輔助穩定身體。\n\n02 緩慢讓把手回升，控制肌肉受力，感受到三頭肌的延伸與舒張。\n\n03 感覺三頭肌收縮發力，用力將把手向下壓至手臂伸直，專注於單側肌肉的孤立收縮感。",

  "反手直桿下壓": "01 雙手反握（掌心朝上）直桿，手肘夾緊身體兩側，維持穩定站姿。\n\n02 緩慢讓直桿隨繩索回升，控制手臂張力，感受到三頭肌的拉長與舒張。\n\n03 感覺三頭肌收縮，強力將直桿向下壓至手臂完全伸直，專注於三頭肌內側的收縮感。",
