...
export const DietView: React.FC = () => {
  ...
  const [subTab, setSubTab] = useState<'nutrition' | 'body'>('nutrition');
  ...
  return (
    <div className="space-y-8 pb-24">
      ...
      {/* 飲食小分頁切換 */}
      <div className="mx-1 grid grid-cols-2 bg-slate-100 p-1 rounded-[20px] border border-black/[0.03] gap-1">
        <button
          onClick={() => setSubTab('nutrition')}
          className={`py-3 rounded-[16px] text-xs font-black uppercase tracking-widest transition-all ${
            subTab === 'nutrition'
              ? 'bg-[#CCFF00] text-black shadow-md'
              : 'bg-white text-black shadow-sm hover:opacity-80'
          }`}
        >
          營養建議
        </button>
            ...
            <div style={{ backgroundColor: lightTheme.bg }} className="rounded-[44px] p-9 border border-black/5 relative overflow-hidden shadow-xl">
               <div className="flex justify-between items-center mb-9">
                  <div className="flex items-center gap-5">
                     ...
                     <div>
                       <h3 style={{ color: lightTheme.text }} className="text-[19px] font-black uppercase tracking-tighter leading-none">營養建議</h3>
               ...
               <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-3">
                     ...
                     <div className="p-6 rounded-2xl border border-black/[0.06] bg-white shadow-sm">
                   ...
                   <div style={{ backgroundColor: '#FFF9E6' }} className="px-7 py-7 rounded-[32px] border border-amber-200/50 flex flex-col gap-2.5 shadow-sm">
            ...
            <div style={{ backgroundColor: lightTheme.bg }} className="rounded-[44px] p-9 border border-black/5 relative overflow-hidden shadow-xl">
              <div className="flex justify-between items-center mb-11">
                 <div className="flex items-center gap-5">
                   ...
                   <div>
                     <h3 style={{ color: lightTheme.text }} className="text-[19px] font-black uppercase tracking-tighter leading-none">身體資料</h3>
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="p-5 rounded-2xl border border-black/[0.06] bg-white flex flex-col shadow-sm">
                ...
                <div className="px-7 py-6 rounded-[28px] border border-black/[0.06] bg-white flex flex-col gap-2 shadow-sm">
                ...
                {/* 體重趨勢圖 */}
                <div className="px-7 py-6 rounded-[28px] border border-black/[0.06] bg-white flex flex-col gap-4 shadow-sm">
                    ...
                    <details className="group">
                      ...
                      <div className="mt-4 space-y-2 max-h-48 overflow-y-auto pr-1">
                        {bodyMetrics.map((m) => (
                          <div 
                            key={m.id || m.date} 
                            className="px-5 py-3 rounded-xl border border-black/[0.04] bg-white flex items-center justify-between text-xs gap-3 shadow-sm"
                          >
 ...
 const MacroCard = ({ icon, label, val, unit, color }: any) => (
   <div className="p-5 rounded-[24px] border border-black/[0.06] bg-white flex items-center justify-between gap-4 shadow-sm">
...
const InputBox = ({ icon, label, val, unit, onChange }: any) => (
  <div className="p-5 rounded-2xl border border-black/[0.06] bg-white flex-1 shadow-sm">
    <div className="flex items-center gap-3 mb-3">
       {icon}
