...
const EXERCISE_MEDIA_REGISTRY: Record<string, string> = new Proxy({}, {
  get: (_target, prop: string) => getExerciseGifUrl(prop)
});
...
const EXERCISE_METHODS: Record<string, string> = {
  ...
  "上斜器械腿推": "01 斜躺於座墊，雙腳踩在踏板中央與肩同寬，解鎖安全把手後伸直雙腿但不鎖死膝蓋。\n\n02 緩慢彎曲手肘下降身體，直到感受胸肌下緣有明顯的牽拉感與舒張。\n\n03 感覺胸肌下緣收縮發力，將身體撐回起始位置，過程保持肩部穩定。",

  "水平器械腿推": "01 坐在機器上並將雙腳平放於踏板，與肩同寬。\n\n02 用力推開踏板直到雙腿伸直，注意膝蓋不鎖死。\n\n03 緩慢控制重量回放，感受股四頭肌的受力與舒張。",
