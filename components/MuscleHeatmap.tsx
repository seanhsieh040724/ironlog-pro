...
export const MuscleHeatmap: React.FC<MuscleHeatmapProps> = ({ scores }) => {
  ...
  // Fix: Use a named easing string instead of a number array to avoid TypeScript inference issues
  const transition = { duration: 1, ease: "circOut" };
